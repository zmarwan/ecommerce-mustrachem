...
export default function PlaceOrderScreen(props) {
  ...
  cart.shippingPrice = cart.itemsPrice>300 ? toPrice(0) : toPrice(50);
          ...
          <ul>
            ...
            <li>
              <div className="card card-body">
                <h2>Paiement</h2>
                <p>
                  <strong>Moyen:</strong> {cart.paymentMethod}
                </p>
              </div>
            </li>
            <li>
          ...
          <div className="card card-body">
            <ul>
              ...
              <li>
                <div className="row">
                  <div>Produits</div>
                  <div>{cart.itemsPrice.toFixed(2)}DH</div>
                </div>
              </li>
              <li>
                <div className="row">
                  <div>Frais de livraison</div>
                  <div>{cart.shippingPrice.toFixed(2)}DH</div>
                </div>
              </li>
              <li>
                <div className="row">
